...
require_relative "../_lib/crystal_lexer"
...
site.add_projects(
  ...
  Project.new(name: "jennifer_sqlite3_adapter", doc_builder: "sh generate-docs.sh", skip_versions: %w(0.1.0)),
  Project.new(name: "form_object", doc_builder: "sh generate-docs.sh", skip_versions: %w(0.2.0)),
  ...
  Project.new(name: "email_opener", doc_builder: "sh generate-docs.sh"),
